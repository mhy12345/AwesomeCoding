...
function p(e){if(typeof e==="string"){return y.call(this,e)}else{return _(this).from(e)}}function d(e){return _(this).alloc(e)}function v(e,r){if(!r){r=0
...
function m(e){return e instanceof ArrayBuffer||g(e)}function y(e){var t=e.length*3
var r=d.call(this,t)
...
function m(e,t){if(e===t){return 0}if(e>t){return 1}return-1}function y(e,t){var r=e.generatedLine-t.generatedLine
if(r!==0){return r}r=e.generatedColumn-t.generatedColumn
if(r!==0){return r}r=m(e.source,t.source)
if(r!==0){return r}r=e.originalLine-t.originalLine
if(r!==0){return r}r=e.originalColumn-t.originalColumn
if(r!==0){return r}return m(e.name,t.name)}t.compareByGeneratedPositionsInflated=y},function(e,t,r){function n(e){return e&&(e.len instanceof Function?e.len():e.length)||0}function i(e){return e?e.toArray?e.toArray():e:[]}var o=t.VERSION=2
var a=t.SPIV=2
var s=t.MSG={AUTH:1,PUSH:2,STATS:3,PING:4,PONG:5,CHANGE:6,STATE:7,PREPARE:8,RECSTART:9,RECSTOP:10,CALLBACK:11,PUBLISH:12,CONNECTED:13,FORK:15,AUTOSAVE:16,RECREVERT:17,ROLLBACK:18,JOIN:20,LEAVE:21,SYNC:22,SYNCED:23,ERROR:24,ALERT:25,SID:26,TRACKING:27,VIEWSTATE:28,STREAMAPPEND:100,STREAMSTATE:101,STREAMRANGE:102,STREAMGETRANGE:103,STREAMTRIM:104,STREAMERROR:105,STREAMFLATTEN:106,CASTLOCK:110,OK:200,UNAUTHORIZED:401,ERR_NOTFOUND:404,REQUEST_TIMEOUT:408,ERR_PAYLOAD_TOO_LARGE:413,ERR_LOCKED:423,ERR_OUT_OF_RANGE:416,RELOAD_STYLES:1e3,UPDATES_AVAILABLE:1001}
var u=t.ACTION_MAP={}
var f=t.WIDGET_TYPE_MAP={}
var c=t.GRANT={SHOW:1,EDIT:2}
var l=t.DIRTY={SIZE:1,LAYOUT:2}
var h=t.ACTION={}
if(true){window.PROTOCOL_ACTION=h}var p=t.WIDGET={CREATE:15,FLAG:17,UNFLAG:18,UPDATE:20,APPEND:21,CONFIGURE:25,BATCH:27,LAYOUT:28}
p.FLAGS={Created:1,Enabled:2,Deleted:4}
var d=t.CAST=Object.create(p)
var v=t.FILE=Object.create(p)
var g=t.LAYOUT=Object.create(p)
var m=t.AGENT=Object.create(p)
var y=t.POINTER=Object.create(p)
var _=t.SIMULATOR=Object.create(p)
var E=t.CONSOLE=Object.create(p)
var w=t.STREAM={}
var A=t.DOM={}
var b=t.KEYS=h.KEY_TYPES=["state","pointer","layout","selection","file","focus","hover","active","enabled","visible","busy","fontSize","width","height","resizing","baseStyle","area","externaljs","colspan","hoverEntry","viewbox","class","style","title","log","info","warn","error","alert","meta","function","element","instance","udef","more","array","div","p","h1","h2","h3","h4","h5","h6","span","b","i","u","get","post","put","options","left","top","contentLeft","contentTop","contentWidth","contentheight","scrollTop","scrollLeft","scrollWidth","scrollHeight","lineHeight","maxWidth","maxHeight"]
for(let e=0,t=i(b),r=t.length;e<r;e++){b[t[e].toUpperCase()]=e}var S=t.SCON={parsedURICache:{},clone:function(e){return JSON.parse(JSON.stringify(e))},compare:function(e,t){return JSON.stringify(e)==JSON.stringify(t)},keyToRef:function(e){return b.indexOf(e)>=0?b.indexOf(e):e},refToKey:function(e){return typeof e=="number"?b[e]||e:e},paths:{},strToPath:function(e){if(this[e]){return this[e]}let t=e.split(".")
...
if(r){return r}let n=e.match(/(scrimba\:\/\/)?(c[\w\-]+)(\@(\d+))?/)
let o={cid:n[2],index:n[4]}
var t=i(e.substr(n[0].length).split("#"))
let a=t[0],s=t[1]
o.path=a
...
function R(){}t.LCRange=R
R.lclcToArray=function(e,t,r,n){if(r==e&&n==t||r==null&&n==null){return[e,t]}else if(r==e){return[e,t,n-t]}else{return[e,t,n-t,r-e]}}
R.rangeToArray=function(e){var t=[e.startLineNumber,e.startColumn,e.endColumn-e.startColumn,e.endLineNumber-e.startLineNumber]
if(t[3]==0){t.pop()
if(t[2]==0){t.pop()}}return t}
R.selectionToArray=function(e){var t=[e.selectionStartLineNumber,e.selectionStartColumn,e.positionColumn-e.selectionStartColumn,e.positionLineNumber-e.selectionStartLineNumber]
if(t[3]==0){t.pop()
if(t[2]==0){t.pop()}}return t}
h.SET=1
h.PATCH=2
h.WIDGET_CREATE=p.CREATE=3
h.LCINSERT=v.LCINSERT=4
h.LCDELETE=v.LCDELETE=5
h.LCEDIT=v.LCEDIT=6
h.LCSELECTION=v.LCSELECTION=7
h.LAYOUT=8
h.BROWSER_LAYOUT=9
h.NODE_LAYOUT=10
h.POINTER_UPDATE=12
h.CONSOLE_LOG=E.LOG=16
h.CONSOLE_CLEAR=E.CLEAR=17
h.CONSOLE_VAL_EXPAND=E.VAL_EXPAND=18
h.DOM_MUTATE=A.MUTATE=21
h.DOM_EVENT=A.EVENT=22
h.DOM_SCROLL=A.SCROLL=23
h.DOM_SELECTION=A.SELECTION=24
h.DOM_FOCUSIN=A.FOCUSIN=25
h.DOM_HOVERIN=A.HOVERIN=26
h.DOM_ACTIVEIN=A.ACTIVEIN=27
h.PAGE_LOAD=28
h.PAGE_LOADED=29
h.PAGE_LOG=30
h.PAGE_REQUEST=31
h.RECSTART=d.RECSTART=33
h.RECSTOP=d.RECSTOP=34
h.PING=d.PING=35
h.SNAPSHOT=d.SNAPSHOT=36
h.FORK=d.FORK=37
h.BRANCH=d.BRANCH=38
h.TRIM=39
h.PAGE_UNLOAD=50
h.LOCK=100
h.UNLOCK=101
...
h.FS_REMOVE=111
h.FS_MOVE=112
h.WIDGET_FLAG=p.FLAG=126
h.WIDGET_UNFLAG=p.UNFLAG=127
h.WIDGET_APPEND=p.APPEND=128
h.SIM_BUILD=_.BUILD=200
h.SIM_RESULT=_.RESULT=201
h.DOM_FOCUSOUT=A.FOCUSOUT=202
h.DOM_HOVEROUT=A.HOVEROUT=203
h.DOM_ACTIVEOUT=A.ACTIVEOUT=204
h.DOM_INSERT=A.INSERT=206
h.DOM_RESET=A.RESET=207
h.LCSCROLL=v.SCROLL=210
d.WORKSPACE=-1
d.CONSOLE=-2
d.SIMULATOR=-3
d.INSPECTOR=-4
...
d.PRIMARY_EDITOR=-9
d.EXPLORER_PANEL=-10
d.DEPENDENCIES_PANEL=-11
d.SLIDES=-12
d.SIDEBAR=-13
w.TRIM=50
E.LOG_TYPES={LOG:60,WARN:61,ERROR:62,RESULT:63,INFO:71,META:72,META_ERROR:73}
E.TYPES={MARKER:"~",NULL:1,UNDEFINED:2,ELEMENT:3,FUNCTION:4,INSTANCE:5,ERROR:6}
y.STATEFLAGS={LEFT_BUTTON:1,RIGHT_BUTTON:2,MIDDLE_BUTTON:4,HIDDEN:8,TRANSITION:16,HIGHLIGHT:32,CTRL:64,ALT:128,SHIFT:256}
y.FLAGS={Created:1,Enabled:2,Deleted:4,Visible:8}
y.STYLES={DEFAULT:0,ROW:1,SMALL_FLIPPED:2}
var T=t.POINTERMASK={LEFT_BUTTON:1,RIGHT_BUTTON:2,MIDDLE_BUTTON:4}
var O=t.LAYOUTMASK={SCALED:1,BOUNDLESS:2}
A.MUTS={RESET:1,INSERT:2,REMOVE:3,INIT:4,INSERT_AFTER:5,INSERT_ADJACENT:6,SETATTR:10,SETPROP:11,SETTEXT:12,POS:["beforebegin","afterbegin","beforeend","afterend"],NAMES:{class:1,value:2,checked:3,style:4},NAME_MAP:{1:"class",2:"value",3:"checked",4:"style"}}
var C=r(40)
var N=t.Bufferish=C.Decoder.prototype.bufferish
function M(e,t){this._socket=t
if(false){}else{this._data=new Uint8Array(e)}var r=new C.Decoder
r.write(this._data)
...
this}t.Packet=M
M.prototype.params=function(e){return this._params}
M.prototype.setParams=function(e){this._params=e
return this}
M.prototype.socket=function(e){return this._socket}
M.prototype.setSocket=function(e){this._socket=e
return this}
M.prototype.data=function(e){return this._data}
M.prototype.setData=function(e){this._data=e
return this}
M.prototype.payloadSize=function(){return this._data.byteLength-this._offset}
M.prototype.retain=function(){if(false){}return this}
M.prototype.payload=function(){if(false){}else{return this._payload||(this._payload=this._data.subarray(this._offset))}}
M.prototype.reply=function(e){if(this._ref){e=N.concat([C.encode(this._ref),e])}this.socket().send(e)
return this}
M.prototype.sid=function(){return this.socket().sid}},function(e,t){var r={}
...
if("string"===typeof n){B(t,r,n,s||10)}else if(_(n,s)){E(t,r,n,s)}else if("number"===typeof s){F(t,r+i,n)
F(t,r+o,s)}else if(n>0){C(t,r,n)}else if(n<0){N(t,r,n)}else{E(t,r,c,0)}}function B(e,t,r,n){var a=0
var s=r.length
var u=0
var f=0
if(r[0]==="-")a++
...
F(e,t+o,f)}function U(){var e=this.buffer
var t=this.offset
var r=j(e,t+i)
var a=j(e,t+o)
if(!n)r|=0
...
return w(t,r)}function m(t){var r=this.buffer
var n=this.offset
d=s
if(t!==false&&n===0&&r.length===8&&e.isBuffer(r))return r
var i=new s(8)
E(i,0,r,n)
return i}function y(e){var t=this.buffer
var r=this.offset
var n=t.buffer
d=u
...
return e}
function c(e,t,r,n){if(typeof t==="number"){throw new TypeError('"value" argument must not be a number')}if(typeof ArrayBuffer!=="undefined"&&t instanceof ArrayBuffer){return g(e,t,r,n)}if(typeof t==="string"){return d(e,t,r)}return m(e,t)}f.from=function(e,t,r){return c(null,e,t,r)}
...
e=u(e,n)
var i=e.write(t,r)
if(i!==n){e=e.slice(0,i)}return e}function v(e,t){var r=t.length<0?0:y(t.length)|0
e=u(e,r)
...
e.__proto__=f.prototype}else{e=v(e,t)}return e}function m(e,t){if(f.isBuffer(t)){var r=y(t.length)|0
e=u(e,r)
...
while(true){switch(e){case"hex":return U(this,t,r)
case"utf8":case"utf-8":return x(this,t,r)
case"ascii":return k(this,t,r)
case"latin1":case"binary":return B(this,t,r)
...
if(s<a)return 1
return 0}
function b(e,t,r,n,i){if(e.length===0)return-1
...
else return-1}if(typeof t==="string"){t=f.from(t,n)}if(f.isBuffer(t)){if(t.length===0){return-1}return S(e,t,r,n,i)}else if(typeof t==="number"){t=t&255
if(f.TYPED_ARRAY_SUPPORT&&typeof Uint8Array.prototype.indexOf==="function"){if(i){return Uint8Array.prototype.indexOf.call(e,t,r)}else{return Uint8Array.prototype.lastIndexOf.call(e,t,r)}}return S(e,[t],r,n,i)}throw new TypeError("val must be string, number or Buffer")}function S(e,t,r,n,i){var o=1
var a=e.length
var s=t.length
...
f.prototype.indexOf=function e(t,r,n){return b(this,t,r,n,true)}
f.prototype.lastIndexOf=function e(t,r,n){return b(this,t,r,n,false)}
...
if(isNaN(s))return a
e[r+a]=s}return a}function T(e,t,r,n){return ee($(t,e.length-r),e,r,n)}function O(e,t,r,n){return ee(J(t),e,r,n)}function C(e,t,r,n){return O(e,t,r,n)}function N(e,t,r,n){return ee(Z(t),e,r,n)}function M(e,t,r,n){return ee(Q(t,e.length-r),e,r,n)}f.prototype.write=function e(t,r,n,i){if(r===undefined){i="utf8"
n=this.length
...
case"latin1":case"binary":return C(this,t,r,n)
case"base64":return N(this,t,r,n)
...
for(var i=t;i<r;++i){n+=String.fromCharCode(e[i]&127)}return n}function B(e,t,r){var n=""
r=Math.min(e.length,r)
for(var i=t;i<r;++i){n+=String.fromCharCode(e[i])}return n}function U(e,t,r){var n=e.length
if(!t||t<0)t=0
if(!r||r<0||r>n)r=n
var i=""
...
var W=/[^+\/0-9A-Za-z-_]/g
function K(e){e=X(e).replace(W,"")
if(e.length<2)return""
while(e.length%4!==0){e=e+"="}return e}function X(e){if(e.trim)return e.trim()
...
i=r%256
o.push(i)
o.push(n)}return o}function Z(e){return n.toByteArray(K(e))}function ee(e,t,r,n){for(var i=0;i<n;++i){if(i+r>=t.length||i>=e.length)break
...
var i=e[r]||(e[r]={})
return i[t]||(i[t]=[])}})(n)},function(e,t,r){var n={}
var i=r(2),o=i.SCON,a=i.KEYS,s=i.ACTION
t.serializeReferences=n.serializeReferences=function(e){var t=/\/\*§SR§(\w+)§START\*\/([^]*?)\/\*§SR§END\*\//gm
return e.replace(t,function(e,t,r){return"/*§SR§"+t+"§*/"})}
t.deserializeReferences=n.deserializeReferences=function(e,t){var r=/\/\*§SR§(\w+)§\*\//gm
return e.replace(r,function(r,n){var i=t instanceof Function?t(e,n):t[n]
return"/*§SR§"+n+"§START*/"+i+"/*§SR§END*/"})}
t.wrapReferencedValue=n.wrapReferencedValue=function(e,t,r){if(r===undefined)r="html"
if(r=="css"){return"/*§SR§"+e+"§START*/"+t+"/*§SR§END*/"}else if(r=="html"){return"\x3c!--§SR§"+e+"§START--\x3e"+t+"\x3c!--§SR§END--\x3e"}else{return""}}
t.serializeAttributes=n.serializeAttributes=function(e){var t=[]
Array.from(e.attributes).forEach(function(e){let r=o.keyToRef(e.name)
t.push(r)
return t.push(e.value||null)})
t.RAW=true
return t}
t.serializeNode=n.serializeNode=function(e,t,r,i){var o
var a
var s=e.createNodeIterator(t,NodeFilter.SHOW_TEXT,null)
while(o=s.nextNode()){var u=a&&o.previousSibling==a
var f=o.textContent==""
if(u||f){if(!r){return n.serializeNode(e,t.cloneNode(true),true,i)}if(f){o.parentNode.insertBefore(e.createComment("§S§B"),o)}else if(u){o.parentNode.insertBefore(e.createComment("§S§"),o)}}a=o}var c=i?t.innerHTML:t.outerHTML
var l=/\/\*SCRIMBA:IGNORE:START\*\/([^]*?)\/\*SCRIMBA:IGNORE:END\*\//gm
c=c.replace(l," ")
c=n.serializeReferences(c)
...
var r=e&&e.int64
var n=f&&e&&e.usemap
var i={map:n?p:h,array:d,str:v,bin:t?m:g,ext:y,uint8:_,uint16:w,uint32:b,uint64:R(8,r?C:T),int8:E,int16:A,int32:S,int64:R(8,r?N:O),float32:R(4,M),float64:R(8,L)}
...
return s.from(i)}function m(e,t){var r=e.reserve(t)
var n=r+t
var i=u.slice.call(e.buffer,r,n)
return s.Uint8Array.from(i).buffer}function y(e,t){var r=e.reserve(t+1)
var n=e.buffer[r++]
var i=r+t
...
var r=e.buffer
var n=r[t++]<<8|r[t]
return n&32768?n-65536:n}function b(e){var t=e.reserve(4)
var r=e.buffer
return r[t++]*16777216+(r[t++]<<16)+(r[t++]<<8)+r[t]}function S(e){var t=e.reserve(4)
var r=e.buffer
return r[t++]<<24|r[t++]<<16|r[t++]<<8|r[t]}function R(e,t){return function(r){var n=r.reserve(e)
return t.call(r.buffer,n,c)}}function T(e){return new o(this,e).toNumber()}function O(e){return new a(this,e).toNumber()}function C(e){return new o(this,e)}function N(e){return new a(this,e)}function M(e){return n.read(this,e,false,23,4)}function L(e){return n.read(this,e,false,52,8)}},function(e,t){var r=t.uint8=new Array(256)
...
return[c.ERROR,t]}var m=t.constructor
var y=o.extractFunctionName(m)
if(y=="Error"){return t}else if(m==Object){return t}else{return[c.INSTANCE,y||"Object"]}}else{return t}}
var v=0
...
var t=[e,this.serializeAttributes(this._html)]
this.emit("op",[c.PAGE_LOADED,t])
this.reindexNodes()
return this}
...
function m(){this._count=0
this._current=Promise.resolve(null)}m.prototype.onError=function(e){}
m.prototype.onComplete=function(){}
m.prototype.push=function(e){var t=this
...
r._system.defineAlias("@angular/common/http","@angular/common/bundles/common-http.umd")
r._system.defineAlias("@angular/common/http.js","@angular/common/bundles/common-http.umd.js")
r._system.defineAlias("@angular/common/testing","@angular/common/bundles/common-testing.umd")
r._system.defineAlias("@angular/common/testing.js","@angular/common/bundles/common-testing.umd.js")
...
t=o[e]
r._sourceMaps[e]=new l(t)}}t.PackageLoader=y
y.prototype.id=function(){return this._options.id}
y.prototype.structureHash=function(){return this._structureHash||(this._structureHash=this.computeStructureHash(this._options.structure))}
y.prototype.computeStructureHash=function(e){var t=""
for(let r=0,i=n(e),o=i.length,a;r<o;r++){a=i[r]
t+=""+a.path+"/"+a.spec}return t}
y.prototype.cacheDatabase=function(){return this._cacheDatabase||(this._cacheDatabase=this.openCacheDatabase())}
y.prototype.openCacheDatabase=function(){if(!h){return}try{var e=h.open("npmLoaderCache",2)}catch(e){return Promise.resolve(null)}e.onupgradeneeded=function(){var t=e.result
...
y.prototype.cacheStore=function(e){return e.transaction("data","readwrite").objectStore("data")}
y.prototype.readCache=async function(){var e
...
y.prototype.clearOldEntries=function(e){var t=this
var r=Date.now()
var n=1e3*60*60*24
...
y.prototype.writeCache=async function(){var e=await this.cacheDatabase()
...
y.prototype.loaderQueue=function(){var e=this,t
return e._loaderQueue||(e._loaderQueue=(t=new m,t.push(function(){return e.initialLoad()}),t.onError=function(t){console.log(t)
return e.completeVerboseLoading()},t.onComplete=function(){e.writeCache()
return e.completeVerboseLoading()},t))}
y.prototype.initialLoad=async function(){await this.readCache()
for(let e=0,t=n(this._hacks),r=t.length;e<r;e++){await this._loader.import(g(t[e]))}return true}
y.prototype.load=function(e){var t=this
return t.loaderQueue().push(function(){return t._loader.import(e)})}
y.prototype.loadVerbose=function(e){var t=this
...
return t}
y.prototype.completeVerboseLoading=function(){if(this._verbose=="logged"){if(this._tracker){this._tracker.log("Loaded modules successfully!")
this._tracker.post({type:"loader:done"})}}if(this._verboseTimeout){clearTimeout(this._verboseTimeout)}return this._verbose=null}
y.prototype.patchStackFrame=function(e){var t
...
return this}
ModuleExecution.prototype.add=function(e,t){if(/\.json/.test(e)){t="module.exports = "+t}var r=this._pre+t+this._post
...
ModuleLoader.prototype.preload=async function(e){e=this._system.resolveAlias(e)
var t=await this.resolve(e,"/")
...
if(r._system.isResolved(t,e)){if(n=r._system.resolve(t,e)){return r.queueModule(n)}}else{var i=r._system.resolveAlias(t)
var o=function(n){r._system.registerResolve(t,e,n)
return r.queueModule(n)}
var a=function(n){return r._system.registerResolve(t,e,null)}
return r.resolve(i,e).then(o,a)}}
n=i.map(o)
await Promise.all(n)
return r}
...
s.prototype.defineAlias=function(e,t){return this._alias[e]=t}
s.prototype.resolveAlias=function(e){var t
if(t=this._alias[e]){return t}return e}
...
e[200]=y(200)
e[201]=_(201)
e[202]=E(202,4,h.writeFloatBE||b,true)
e[203]=E(203,8,h.writeDoubleBE||S,true)
e[204]=m(204)
e[205]=y(205)
e[206]=_(206)
e[207]=E(207,8,w)
...
return e}function m(e){return function(t,r){var n=t.reserve(2)
var i=t.buffer
i[n++]=e
i[n]=r}}function y(e){return function(t,r){var n=t.reserve(3)
var i=t.buffer
i[n++]=e
i[n++]=r>>>8
...
i.buffer[a++]=e
r.call(i.buffer,o,a,n)}}function w(e,t){new o(this,t,e)}function A(e,t){new a(this,t,e)}function b(e,t){n.write(this,e,t,false,23,4)}function S(e,t){n.write(this,e,t,false,52,8)}},function(e,t,r){var n=r(4)
var i=r(7)
var o=i.Uint64BE
var a=i.Int64BE
var s=r(0)
...
var m=p&&e&&e.usemap
var y=m?k:I
var _={boolean:E,function:N,number:w,object:r?C:O,string:T(r?R:S),symbol:N,undefined:N}
return _
...
t[n](e,r.toArray())}function b(e,r){var n=211
t[n](e,r.toArray())}function S(e){return e<32?1:e<=255?2:e<=65535?3:5}function R(e){return e<32?1:e<=65535?3:5}function T(e){return r
...
t[p](r,i)
r.offset+=i}}function O(e,t){if(t===null)return N(e,t)
if(v(t))return g(e,t)
if(n(t))return M(e,t)
if(o.isUint64BE(t))return A(e,t)
if(a.isInt64BE(t))return b(e,t)
var r=e.codec.getExtPacker(t)
if(r)t=r(t)
if(t instanceof l)return P(e,t)
y(e,t)}function C(e,t){if(v(t))return B(e,t)
O(e,t)}function N(e,r){var n=192
...
o(e,t)})}function B(e,r){var n=r.length
...
b=g.value
d=g.rest
w.push(b)}if(w.length===2){throw new Error("Found a source, but no line and column")}if(w.length===3){throw new Error("Found a source and line, but no column")}v[E]=w}_.generatedColumn=o+w[0]
o=_.generatedColumn
...
h+=w[4]}}y.push(_)
if(typeof _.originalLine==="number"){m.push(_)}}}s(y,n.compareByGeneratedPositionsDeflated)
this.__generatedMappings=y
s(m,n.compareByOriginalPositions)
...
var c=console
var l=r(29).PackageLoader
window.SCRIMBA_PackageLoader=l
try{var h=window.localStorage.getItem("DEBUG_TRACKER")}catch(e){}function p(e){var t=this
...
window.addEventListener("hashchange",function(e){return t.post({type:"location",url:document.location.href})},true)
window.addEventListener("beforeunload",function(e){t.log("beforeunload",e)
t.post({type:"beforeunload",predictedTarget:window.SCRIMBA_EXIT_HREF})
return},true)
...
window.console=t._console=new u(t)
t._console.queue()
document.addEventListener("DOMContentLoaded",function(e){if(h){t.log("DOMContentLoaded",document.documentElement.innerHTML)}t.domContentLoaded()
return t._console.flush()})
t.post({type:"pageload",status:t._status,url:r})}p.prototype.log=function(){var e=arguments,t=e.length
var r=new Array(t>0?t:0)
while(t>0)r[t-1]=e[--t]
return c.log.apply(c,r)}
p.prototype.predictTarget=function(e){window.SCRIMBA_EXIT_HREF=e
return setTimeout(function(){if(window.SCRIMBA_EXIT_HREF==e){return window.SCRIMBA_EXIT_HREF=null}},500)}
p.prototype.receive=function(e,t){var r
...
p.prototype.domContentLoaded=function(){this._recorder=new s(this,{logger:c,loglevel:h?3:0})
this._recorder.attachTo(window)
return this._recorder.activate()}
p.prototype.overrideStyle=function(e,t){if(this._recorder){return this._recorder.overrideStyle(e,t)}}
p.prototype.canPush=function(){return this._state!="cancelled"}
p.prototype.pushOne=function(e,t){if(t===undefined)t=[]
return this.push([[e,t]])}
p.prototype.push=function(e){if(h){this.log("push",e)}if(!this.canPush()){return}var t=Date.now()
...
return this}
p.prototype.estimateSize=function(e){var t=0
for(let r=0,i=n(e),o=i.length,a;r<o;r++){a=i[r]
if(!a){}else if(typeof a=="number"){t+=1}else if(typeof a=="string"){t+=a.length}else if(a.length!=null){t+=this.estimateSize(a)}}return t}
p.prototype.cancel=function(){this._state="cancelled"
this.post({type:"cancelled"})
if(this._recorder){return this._recorder.deactivate()}}
p.prototype.post=function(e){if(this._receiver!=window){return this._receiver.postMessage(e,"*")}}
p.prototype.ondommutate=function(e){return this.pushOne(e[0],e[1])}
p.prototype.ondomop=function(e){return this.pushOne(e[0],e[1])}
p.prototype.ondomevent=function(e){this.post({type:"domevent",data:{timeStamp:Date.now(),clientX:e.clientX,clientY:e.clientY,windowHeight:window.innerHeight,windowWidth:window.innerWidth,buttons:e.buttons,shiftKey:e.shiftKey,type:e.type}})
return this}
var d=new p(window.parent)
window.SCRIMBA_TRACKER=d}])
